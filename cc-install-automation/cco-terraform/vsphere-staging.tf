...
cluster = "hx-cluster"
template = "sestraub/cc-automated-installation/tmpl-centos-7-terraform"
long_name = "cloudcenter"
short_name = "cc"
folder = "sestraub/cc-automated-installation/cco"
folder_worker1 = "sestraub/cc-automated-installation/worker"
